...
first side project in years i haven't abandoned halfway through. and i had many, they just was not useful enough for me.
...
since most of the nodes create clusters, i was wondering if there's some connection between random nodes which are not from the same cluster; something like "not obvious connections" between observations and stuff. i called these nodes "dreams" because it sounds vague lol and also it's not a serious feature with a lot of intended hallucinations. yet still i sometimes got interesting insights like this
